      ...
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-8 hover:shadow-xl transition-shadow duration-300 border border-gray-200">
        ...
        <form action={handleSubmit} className="flex flex-col gap-4">
          <div className="relative">
            ...
            <label
              htmlFor="email"
              className="absolute right-3 top-3 text-gray-500 text-sm transition-all pointer-events-none peer-placeholder-shown:top-3 peer-focus:top-0 peer-focus:text-xs"
            >
          ...
          <button
            type="submit"
            className="bg-[#EF4056] text-white p-3 rounded-lg hover:bg-[#c73548] hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 font-semibold text-md shadow-md hover:shadow-lg cursor-pointer"
          >
            ورود به دیجی‌کالا
          </button>
        </form>
